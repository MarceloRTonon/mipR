...
- **geom_(?)**: aqui você vai indicar a forma que seu gráfico terá, modificando o final da função com, por exemplo, "point", "line", "bar", entre outros.
...
Para escolher a cor das bordas, do preenchimento, ou ambas, existem algumas opções:
...
- Pode ser uma especificação RGB (red, green and blue) por meio de uma string da forma "#RRGGBB" com cada par de RR, GG e BB representando um nível para cada cor.

- Por fim, se colocar `NA` para deixar um gráfico transparente.
