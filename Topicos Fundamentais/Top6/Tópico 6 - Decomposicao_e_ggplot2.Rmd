...
0 = vazio, 1 = sólido, 2 = tracejado, 3 = pontilhado, 4 = ponto e traço, 5 = tracejado longo, 6 = tracejado curto e longo

Esses tipos de linha podem  ser visualizados tal como figura inspirada na vignette do aesthetics:


```{r, echo=F}
lty <- c("sólido", "tracejado", "pontilhado", "ponto e traço", "tracejado longo", "tracejado curto e longo")
