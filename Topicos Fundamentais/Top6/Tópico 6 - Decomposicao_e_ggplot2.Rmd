...
- Pode ser uma especificação RGB (red, green and blue) por meio de uma string da formaAn rgb specification, with a string of the form "#RRGGBB" where each of the pairs RR, GG,  BB consists of two hexadecimal digits giving a value in the range 00 to FF
