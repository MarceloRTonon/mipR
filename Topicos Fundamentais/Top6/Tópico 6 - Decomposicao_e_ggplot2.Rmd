...
Desse modo, temos que a matriz de coeficientes domésticos diretos da produção $A_n$ é uma matriz interna em relação a Inversa de Leontief. Suponha que queremos então saber os efeitos das mudanças de $A$ em $L$. Desse modo, seja $L^0 = (I-A^0)^{-1}$ e $L^1 = (I-A^1)^{-1}$, **pós-multiplicando** $L^1$ por $(I-A^1)$  teremos:
...
```{r}
deltaL_int1 <- matrizes2010$Leontief
```
