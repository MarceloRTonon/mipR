...
11:14 %>% soma_doida(1:4)
```
Isso pode ser resolvido definindo o argumento de 

 Usaremos a seguir a comparação do operador `%>%` com  `|>`, para descobrirmos outras facilidade


Uma coisa que não falamos antes é que existe um operador `pipe` do *baseR*, o operador `|>`.
mas de se escrever no 
