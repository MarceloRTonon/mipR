...
Assim como na parte expositiva, vamos usar as matrizes do IBGE de 2015. [Clique aqui para baixa-las se você não o fez](ftp.ibge.gov.br/Contas_Nacionais/Matriz_de_Insumo_Produto/2015/Matriz_de_Insumo_Produto_2015_Nivel_67.xls). Iremos nos referir a esse arquivo como **IBGE\_2015.**

**Importante:** Se você não conseguir baixar por esse link, entre no site do IBGE e baixe diretamente de lá!

#### Q.1.1 Crie um tibble `dfQ1.1` com os dados da matriz de coeficientes técnicos intersetoriais (aba 14 de IBGE\_2015) e também as duas colunas com o código e a descrição das atividades. Nomeie também as colunas
...
Nas análises de Matriz Insumo Produto, um dos primeiros indicadores que você irá encontrar é o encadeamento para trás e para frente de determinado setor. Eles serão explorados com mais detalhes no curos, mas, em linhas gerais, eles representam os setores capazes de gerar maior impacto na cadeia produtiva. Seja $i$ um vetor unitario, se calcula os encadeamentos para trás e para frente de cada setor^[Esta seria a versão de Rasmussen-Hirschmann dos indicadores de encadeamento.] das seguintes maneiras $i'[I-A]^{-1}$ (para trás) e $[I-A]^{-1}i$ (para frente). Em outras palavras, a soma das colunas (para trás) e das linhas (para frente) de uma determinada matriz (por exemplo, a de coeficientes técnicos ou a de Leontief).
