...
E iremos usar as matrizes do IBGE de 2015. [Clique aqui para baixa-las](https://ftp.ibge.gov.br/Contas_Nacionais/Matriz_de_Insumo_Produto/2015/Matriz_de_Insumo_Produto_2015_Nivel_67.xls) ou procure no site do IBGE se o link estiver desatualizado. E coloque na pasta `top2`. No geral, tem formas de se baixar diretamente pelo console, porém no site do IBGE isso sempre dá erro.
...
Assim, se quisermos acessar uma base de dados ou outra, basta fazermos `aba1$OfertaDeBensServicos`, `aba1$ProducaoDeAtividades` ou `aba1$Importacoes`. Você tem assim uma forma de diferenciar e acessar ambas ao mesmo tempo.[^7]
