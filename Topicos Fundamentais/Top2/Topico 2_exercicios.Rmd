...
#### D.3.1 - **Desafio:** usando a função `write.xlsx` do pacote `openxlsx`, crie um arquivo `dfQ31.xlsx`. Garanta que os nomes da linhas serão gravados (o default é `rowNames = FALSE`).
