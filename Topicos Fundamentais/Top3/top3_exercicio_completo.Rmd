...
total_output_diag <- diag(as.data.frame(total_output)[,5:60])
Dem_Int_matrix <- as.matrix(as.data.frame(niotITA_8.6)[,5:60])
coef_tec <- total_output_diag%*%Dem_Int_matrix
