...
\_ **Detalhe:** O código que vocẽ vai fazer aqui vai ser ineficiente mesmo. É só para você tentar entender a questão como um todo.
...
all.equal(Dem_Tot, as.double(niotITA_3.5$GO))
