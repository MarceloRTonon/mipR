...
Dica: Use três operadores booleanos para tanto e então compare o resultado com `identical`.
Dica 2: queremos um resultado com comprimento 1 (TRUE ou FALSE).
```{r, include=FALSE}
...
#### Desafio D.1.2 Seguindo o desafio anterior, suponha que você quer criar uma função para saber se o vetor como um todo passa nesse teste (ou seja, se ele retorna tudo como `TRUE`). Como você faria isso? Por que não dá para vocẽ usar 
_
