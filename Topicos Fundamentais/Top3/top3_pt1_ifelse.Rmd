...
=======
=======
>>>>>>> be81fb577df201e6493dada52f3e7b7cac1d656c
```{r}
a <-2
ifelse(a ==2, "Condição válida", "Condição inválida")

b <-3
ifelse(b ==2, "Condição válida", "Condição inválida")
...
ifelse(TRUE, "Condição válida", "Condição inválida")

ifelse(FALSE, "Condição válida", "Condição inválida")
>>>>>>> be81fb577df201e6493dada52f3e7b7cac1d656c
```
