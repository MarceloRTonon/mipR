...
# Filtrando as linhas cuja os valores da coluna Plant seja diferente de "Qn1". 
CO2 %>% filter(Plant != "Qn1")
CO2 %>% filter("Qn1" != Plant)
...
Repare que a ordem que você escreve os elementos a serem comparados não alteram a 
