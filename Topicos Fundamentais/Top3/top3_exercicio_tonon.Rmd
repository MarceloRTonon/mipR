...
ganhadores <- data.frame("Países" = c( "Alemanha", "Argentina","Itália", "França",  "França", "Uruguai", "Espanha","Brasil", "Inglaterra"), "Titulos" = c( 4,2,4,2,2,2,1,5,1))
```
...
```{r}
dfQ4.3 <- americadoSul %>% inner_join()
```

 O número de formas para você fazer isso é mesmo número de mãos que uma pessoa usualmente tem.