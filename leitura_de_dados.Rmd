...
Feitas a introdução de R, iremos neste capítulo do curso apresentar as diferentes formas possíveis em que se pode ler uma base de dados a partir do R. Vamos também apresentar algumas funções e como automatizar o seu código usando loops.
...
#  Automatizando o seu código


Nesta seção, eu vou explicar nesta parte o que é um loop, porquê não fazer as repetições manualmente, vou contextualizar como ele funciona e então apresentar como fazer um loop no R e algumas nuances sobre ele. Assim sendo, se você entende bem porque automatizar seu código é necessário e a lógica de um loop, você pode ir direto para a parte 
