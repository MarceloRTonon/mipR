...
Por este curso ser voltado para análises de Insumo-Produto, há interesse especial na apresentação de dados forma matricial. Para inserir uma matriz precisamos além da equação, inserir um comando para criar a forma de uma matriz
