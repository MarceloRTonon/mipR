...
Na imagem que mostramos também tem um outro botão, com destaque vermelho. Esse serve para você adicionar um branch. Na prática ele faz a mesma coisa que o comando `git push -u origin <branch>`.
...
Aqui está boa parte do que há para aprender sobre como criar

## Merge

Na última seção aprendemos como criar e deletar branches. O que nos interessa agora é aprender a fundir dois branches.
